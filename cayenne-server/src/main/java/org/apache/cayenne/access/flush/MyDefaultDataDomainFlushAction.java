 ...
 * @since 4.2
 */
public class MyDefaultDataDomainFlushAction implements DataDomainFlushAction {
    ...
    protected MyDefaultDataDomainFlushAction(DataDomain dataDomain, DbRowOpSorter dbRowOpSorter, JdbcEventLogger jdbcEventLogger) {
